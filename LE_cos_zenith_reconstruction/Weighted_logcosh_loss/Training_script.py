...
from graphnet.training.loss_functions import CrossEntropyLoss, VonMisesFisher2DLoss, LogCoshLoss, MSELoss, VonMisesFisher3DLoss, WeightedLogCoshLoss
...
parser.add_argument(
    ...
    default='Luc_high_correction_cos_zenith_logcosh'
    # required=True,
)
parser.add_argument(
    "-a",
...
def main():
    ...
    task = CosZenithReconstruction(
        hidden_size=gnn.nb_outputs,
        target_labels=config["target"],
        loss_function=WeightedLogCoshLoss(),
    )
