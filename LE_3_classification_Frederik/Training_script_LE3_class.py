...
parser.add_argument(
    ...
    default='Luc_multiclass_full_db'
    # required=True,
)
parser.add_argument(
    "-a",
...
def main():
    ...
    config = {
        ...
        "patience": 1, #Early stopping, how many epochs without improvements
    }
    ...
    try:
        trainer.fit(model, training_dataloader, validation_dataloader, ckpt_path='/groups/icecube/luc/playground/lightning_logs/version_8/checkpoints/epoch=24-step=65925.ckpt')
