...
parser.add_argument(
    ...
    default='Luc_regression_LE_smalltest'
    # required=True,
)
parser.add_argument(
    "-a",
...
def main():
    ...
    try:
        trainer.fit(model, training_dataloader, validation_dataloader, ckpt_path='/groups/icecube/luc/playground/lightning_logs/version_17/checkpoints/epoch=10-step=17193.ckpt')
